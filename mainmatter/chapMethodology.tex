...
\begin{table}[htb]
\caption{\centering Overview of Identification Phase} 
\label{tab:mytable}
\centering
...
\begin{table}[htb]
\caption{\centering Hardware Requirements} 
\label{tab:mytable}
\centering
...
\begin{table}[htb]
\caption{\centering Software Requirements} 
\label{tab:mytable}
\centering
...
\begin{table}[htb]
\caption{\centering Overview of Development Phase} 
\label{tab:mytable}
\centering
\begin{tabular}{|p{2.2cm}|p{2.6cm}|p{2.6cm}|p{2.6cm}|p{2.6cm}|}
\hline
...
\multirow{1}{*}{%
	\begin{tabular}[c]{@{}p{2.6cm}@{}}
	\vspace{0.1cm} \raggedright User Interface for Alunan mobile application developed \\[6pt]
	\end{tabular}
} \\ \cline{3-5}
& &
\multirow{1}{*}{%
...
\multirow{1}{*}{%
	\begin{tabular}[c]{@{}p{2.6cm}@{}}
	\vspace{0.56cm} \raggedright Database for Alunan mobile application created \\[6pt]
	\end{tabular}
} \\ \hline
\end{tabular}
\end{table}
...
\begin{table}[htb]
\caption{\centering Overview of Prototyping Phase} 
\label{tab:mytable}
\centering
\begin{tabular}{|p{2.2cm}|p{2.6cm}|p{2.6cm}|p{2.6cm}|p{2.6cm}|}
\hline
...
\multirow{1}{*}{%
	\begin{tabular}[c]{@{}p{2.6cm}@{}}
	\vspace{0.5cm} \raggedright A high-fidelity prototype of the Alunan mobile application that includes key features and interactions \\[6pt]
	\end{tabular}
} \\ \hline
\end{tabular}
\end{table}
...
\begin{table}[htb]
\caption{\centering Overview of Testing Phase} 
\label{tab:mytable}
\centering
\begin{tabular}{|p{2.2cm}|p{2.6cm}|p{2.6cm}|p{2.6cm}|p{2.6cm}|}
\hline
...
\multirow{1}{*}{%
	\begin{tabular}[c]{@{}p{2.6cm}@{}}
	\vspace{1.2cm} \raggedright Result of Testing \\[6pt]
	\end{tabular}
} \\ \cline{3-5}
& &
\multirow{1}{*}{%
...
\multirow{1}{*}{%
	\begin{tabular}[c]{@{}p{2.6cm}@{}}
	\vspace{1.46cm} \raggedright SUS Score and User Feedback \\[6pt]
	\end{tabular}
} \\ \hline
\end{tabular}
\end{table}
