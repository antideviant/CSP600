...
\begin{longtable}{|p{3cm}|p{5cm}|p{5cm}|}
    ...
    \multirow{5}{3cm}{\raggedright \textbf{Flow of the event:}} & \textbf{Actor} & \textbf{Application} \\ \cline{2-3}
    & 1. The user clicked on the 'Feed' button on the home screen. & 1. The application displays all the posts from other musicians. \\ \cline{2-3}
    ...
    & 3. The user can clicked on the Spotify URL written in the description of the post. & 3. The application will redirect to the Spotify application to play the music. \\ \cline{2-3}
    & 4. Use case ends. & \\ \hline
...
\begin{longtable}{|p{3cm}|p{5cm}|p{5cm}|}
    ...
    \multirow{5}{3cm}{\raggedright \textbf{Flow of the event:}} & \textbf{Actor} & \textbf{Application} \\ \cline{2-3}
    & 1. The system displays the create account page. & 1. The application verifies userId. \\ \cline{2-3}
    & 2. Users enter first name, second name, email, address, and password. & 2. The application creates the account.  \\ \cline{2-3}
    & 3. Users submit entered details. & 3. The application notifies the customer that the account has been created.  \\ \cline{2-3}
    & 4. Use case ends. &  \\ \hline
    \multirow{4}{3cm}{\raggedright \textbf{Exceptions Flow:}} & \multicolumn{2}{p{10cm}|}{\raggedright E 1.0 If customer enters invalid Customer Account information} \\ \cline{2-3}
    & \multicolumn{2}{p{10cm}|}{\raggedright E 1.1 A display message will pop out “Data is invalid”.} \\ \cline{2-3}
    & \multicolumn{2}{p{10cm}|}{\raggedright E 2.0 If customer enters a username that already exists} \\ \cline{2-3}
    & \multicolumn{2}{p{10cm}|}{\raggedright E 2.1 A display message will pop out “Username already exists.”} \\ \hline
\end{longtable}
\pagebreak
...
\begin{longtable}{|p{3cm}|p{5cm}|p{5cm}|}
    ...
    \multirow{5}{3cm}{\raggedright \textbf{Flow of the event:}} & \textbf{Actor} & \textbf{Application} \\ \cline{2-3}
    & 1. The system displays the Sign-Up page. & 1. The application verifies user details. \\ \cline{2-3}
    & 2. Users enter full name, email address, password, and role as Enthusiast. & 2. The application creates the account.  \\ \cline{2-3}
...
\begin{longtable}{|p{3cm}|p{5cm}|p{5cm}|}
    \caption{System Behavior Summary for Register Use Case} \\
    \hline
    \textbf{Use Case Name:} & \multicolumn{2}{l|}{Register to TukangNow Mobile Application} \\ \hline
    \textbf{Actor:} & \multicolumn{2}{l|}{Customer} \\ \hline
    \textbf{Use Case:} & \multicolumn{2}{l|}{\includegraphics[width=0.5\linewidth]{mainmatter/images/sucd9.png}} \\ \hline
    \textbf{Preconditions:} & \multicolumn{2}{p{10cm}|}{None} \\ \hline
    \textbf{Postconditions:} & \multicolumn{2}{p{10cm}|}{Customer account created.} \\ \hline
    \multirow{5}{3cm}{\raggedright \textbf{Flow of the event:}} & \textbf{Actor} & \textbf{Application} \\ \cline{2-3}
    & 1. The system displays the create account page. & 1. The application verifies userId. \\ \cline{2-3}
    & 2. Users enter first name, second name, email, address, and password. & 2. The application creates the account.  \\ \cline{2-3}
    & 3. Users submit entered details. & 3. The application notifies the customer that the account has been created.  \\ \cline{2-3}
