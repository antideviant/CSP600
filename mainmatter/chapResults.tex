...
\begin{enumerate}[A.]
    ...
    \begin{table}[htb]
        \caption{\centering List of Non-Functional Requirements for the Alunan Mobile Application}
        \label{tab:mytable}
        \centering
    ...
    \begin{table}[htb]
        \caption{\centering List of Software for Alunan Mobile Application} 
        \label{tab:software}
        \centering
