...
\begin{enumerate}[1.]
    ...
    This chapter provides an overview of the system requirements for the Alunan mobile application, focusing on ensuring that both functional and non-functional requirements for hardware and software design are met. This is essential to developing Alunan: A Mobile Application for Local Musicians’ Online Community and Music Discovery. The system underwent testing to assess its capability to fulfill the development goal. Furthermore, the Alunan mobile application's usability was evaluated using the System Usability Scale (SUS), which measures its effectiveness, efficiency, and overall usability. The project's objectives, procedures, and deliverables have been precisely outlined to enable a complete understanding of its content. It is crucial to accurately implement and closely monitor every process involved in the development of the Alunan mobile application.
    \item \textit{Chapter 5: Conclusion and Recommendation} \\
    This chapter concludes with the successful completion of the Alunan mobile application project, marking an important milestone in aligning with the project's objectives, aims, and methodologies. The project begins with requirement gathering, forming the foundation of knowledge. During the design phase, multiple viewpoints provide insights for efficient modifications. The development phase is the most demanding and crucial, with the methodology serving as a set of instructions that directly impact development efficiency. Recommendations and limitations derived from user feedback are documented for future improvements to the Alunan mobile application.
\end{enumerate}